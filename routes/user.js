...
router.post('/get-expense/:pageNumber', userAuthentication.authenticate, expenseRouter.getExpenseDetail);
router.post('/income',userAuthentication.authenticate, incomeRouter.postIncomeDetail);
router.post('/get-income',userAuthentication.authenticate, incomeRouter.getIncomeDetail);
router.delete('/delete-list/:listId',userAuthentication.authenticate, expenseRouter.deleteList);
router.post('/buy-premium', userAuthentication.authenticate, userRouter.buyPremium);
